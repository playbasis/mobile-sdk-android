...
import com.playbasis.android.playbasissdk.http.Network;
import com.playbasis.android.playbasissdk.http.NetworkError;
import com.playbasis.android.playbasissdk.http.NetworkResponse;
import com.playbasis.android.playbasissdk.http.NoConnectionError;
import com.playbasis.android.playbasissdk.http.PlayBasisLog;
import com.playbasis.android.playbasissdk.http.Request;
import com.playbasis.android.playbasissdk.http.RetryPolicy;
import com.playbasis.android.playbasissdk.http.ServerError;
import com.playbasis.android.playbasissdk.http.TimeoutError;
...
/**
 * A network performing Http requests over an {@link HttpStack}.
 */
public class BasicNetwork implements Network {
    protected static final boolean DEBUG = PlayBasisLog.DEBUG;
    ...
    private void logSlowRequests(long requestLifetime, Request<?> request,
        ...
        if (DEBUG || requestLifetime > SLOW_REQUEST_THRESHOLD_MS) {
            PlayBasisLog.d("HTTP response for request=<%s> [lifetime=%d], [size=%s], " +
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                // an invalid state.
                PlayBasisLog.v("Error occured when calling consumingContent");
            }
