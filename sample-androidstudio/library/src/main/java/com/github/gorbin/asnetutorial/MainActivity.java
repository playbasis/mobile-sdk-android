...
public class MainActivity extends FragmentActivity implements FragmentManager.OnBackStackChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String token = GoogleAuthUtil.getToken(MainActivity.this.mSocialNetworkManager.getActivity(), Plus.AccountApi.getAccountName(GooglePlusSocialNetwork.this.googleApiClient), scope);
        //return token;
    }
