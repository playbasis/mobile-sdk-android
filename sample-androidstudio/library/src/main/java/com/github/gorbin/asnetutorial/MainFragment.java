...
//=================================
            ...
            try {
                String token;
                //token = GoogleAuthUtil.getToken(mSocialNetworkManager.getActivity(), Plus.AccountApi.getAccountName(mSocialNetworkManager.googleApiClient), scope);
                // token = GoogleAuthUtil.getToken(mSocialNetworkManager.getActivity(), Plus.AccountApi.getAccountName(mSocialNetworkManager.googleApiClient), scope);
            ...
            //String token;
            //token = GoogleAuthUtil.getToken(mSocialNetworkManager.getActivity(), Plus.AccountApi.getAccountName(GooglePlusSocialNetwork.this.googleApiClient), scope);
            ...
            switch (view.getId()){
                ...
                case R.id.googleplus:
                   // String accessToken = GoogleAuthUtil.getToken(getActivity(), plusClient.getAccountName(),
                    ...
                    //GooglePlusSocialNetwork gpNetwork = new GooglePlusSocialNetwork(MainActivity.this);
                    //String token = GoogleAuthUtil.getToken(mSocialNetworkManager.getActivity(), Plus.AccountApi.getAccountName(GooglePlusSocialNetwork.this.googleApiClient), scope);
